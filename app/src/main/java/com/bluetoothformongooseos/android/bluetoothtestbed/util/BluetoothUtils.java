package com.bluetoothformongooseos.android.bluetoothtestbed.util;
...
import static com.bluetoothformongooseos.android.bluetoothtestbed.Constants.CHARACTERISTIC_ECHO_STRING_SAVE;
import static com.bluetoothformongooseos.android.bluetoothtestbed.Constants.CHARACTERISTIC_ECHO_STRING_VALUE;
import static com.bluetoothformongooseos.android.bluetoothtestbed.Constants.CHARACTERISTIC_ECHO_STRING_KEY;
import static com.bluetoothformongooseos.android.bluetoothtestbed.Constants.SERVICE_STRING;
...
public class BluetoothUtils {
    ...
    @Nullable
    public static BluetoothGattCharacteristic findEchoCharacteristic(BluetoothGatt bluetoothGatt , int characteristicNumber) {
        String uuidString = "";
        if(characteristicNumber == 0){
            uuidString = CHARACTERISTIC_ECHO_STRING_KEY ;
        }
        else if(characteristicNumber == 1){
            uuidString = CHARACTERISTIC_ECHO_STRING_VALUE;
        }

        else if(characteristicNumber == 2){
            uuidString = CHARACTERISTIC_ECHO_STRING_SAVE;
        }
        return findCharacteristic(bluetoothGatt, uuidString);
    }
