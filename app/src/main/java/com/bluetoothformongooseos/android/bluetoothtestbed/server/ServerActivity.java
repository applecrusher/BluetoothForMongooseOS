package com.bluetoothformongooseos.android.bluetoothtestbed.server;
...
import com.bluetoothformongooseos.android.bluetoothtestbed.databinding.ActivityServerBinding;
import com.bluetoothformongooseos.android.bluetoothtestbed.util.BluetoothUtils;
import com.bluetoothformongooseos.android.bluetoothtestbed.util.ByteUtils;
...
//                        | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
        ...
        BluetoothGattCharacteristic writeCharacteristic = new BluetoothGattCharacteristic(null,
                BluetoothGattCharacteristic.PROPERTY_WRITE,
                // Somehow this is not necessary, the client can still enable notifications
//                        | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
                BluetoothGattCharacteristic.PERMISSION_WRITE);
    ...
    private void sendReverseMessage(byte[] message , String characteristicEchoUUIDString) {
        mHandler.post(() -> {
            ...
            notifyCharacteristicEcho(response , characteristicEchoUUIDString);
        });
    }

    public void notifyCharacteristicEcho(byte[] value , String characteristicEchoUUIDString) {
        UUID characteristicEchoUUID = UUID.fromString(characteristicEchoUUIDString);
        notifyCharacteristic(value, characteristicEchoUUID);
    }
